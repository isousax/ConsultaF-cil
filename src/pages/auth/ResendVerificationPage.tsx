  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-green-50 to-blue-50 p-4">
      <Card className="w-full max-w-md p-8">
        ...
        {success && (
          <Alert type="success" className="mb-4" message="E-mail enviado! Verifique sua caixa de entrada e spam. Você pode fechar esta página." />
        )}
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm text-gray-700">
            <strong>Observação:</strong> Há um intervalo de 60 segundos entre cada envio. 
